  ...
  return (
    <nav className="flex flex-wrap items-center justify-between p-3 bg-gradient-to">
      ...
      >
        ...
        {/* Auth Buttons (Right) */}
        <div className="px-6 py-2 bg-gradient-to-r from-amber-400 to-yellow-300 text-black font-semibold rounded-lg shadow-md hover:shadow-lg hover:from-amber-500 hover:to-yellow-400 transition duration-300 ease-in-out">
